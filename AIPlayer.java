...
/**
 * Represents an AI greedddddyyy in the game. The logic for making a move will be based
...
public abstract class AIPlayer extends Player {
    ...
    // Map of AI greedddddyyy types and their corresponding classes
    ...
    // Register AI greedddddyyy types
    ...
    public static AIPlayer createAIPlayer(String aiPlayerType, boolean isPlayerOne) {
        ...
        if (aiPlayerClass == null) {
            throw new IllegalArgumentException("Unknown AI greedddddyyy type: " + aiPlayerType);
        }

        try {
            return aiPlayerClass.getConstructor(boolean.class).newInstance(isPlayerOne);
        } catch (Exception e) {
            throw new RuntimeException("Error creating AI greedddddyyy: " + aiPlayerType, e);
        }
    }

    // Retrieve the list of registered AI greedddddyyy types
